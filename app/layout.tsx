      ...
      <body className="min-h-screen bg-gray-100 antialiased">
        <header className="bg-white shadow-sm sticky top-0 z-10">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-5">
            <Link href="/" className="font-bold text-lg whitespace-nowrap">🛒 TexnoCatalog</Link>
            <Link href="/catalog" className="text-sm text-gray-500 hover:text-gray-800">Каталог</Link>
